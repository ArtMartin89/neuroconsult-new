...
export const metadata: Metadata = {
  ...
  keywords: 'системный консалтинг, ИИ автоматизация, управление бизнесом, системный рост',
  openGraph: {
    title: 'NeuroConsult: Системный рост бизнеса',
    description: 'Системный консалтинг + ИИ-автоматизация = Измеримый рост по всем направлениям уже через 3 месяца',
    type: 'website',
    locale: 'ru_RU',
  },
  twitter: {
